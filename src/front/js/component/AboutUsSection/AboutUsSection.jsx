      ...
      <Container className="my-3">
        <Row>
          <Col md={6} sm={12}>
            ...
            <p>
              <strong>RAJ</strong> es la web que ayuda a personas con problemas
              de ludopatia ,al registro para la auto-exclusión a locales de
              juegos de azar.
              <p>
              ...
              <p>
                ...
                <strong>RAJ</strong> procede a tratar los datos de este ,
                siempre en confidencialidad para que conste en todos los locales
                que este afecta.
              </p>
              <p>
                <strong>RAJ</strong> quiere colaborar con las personas afectadas
                y ayudar con su recuperación mediante este proceso.No es el paso
